...
public class Processus4 {
    ...
    public static void main(String[] args) {
        try {
            ...
            envoyerMessage("Message du P4 vers P1: Images traitées", 5001);
            Thread.sleep(10000);
            ...
            envoyerMessage("Message du P4 vers P3: Encodage terminé", 5003);
            Thread.sleep(10000);
            ...
            envoyerMessage("Message du P4 vers P2: Métadonnées extraites", 5002);
            Thread.sleep(10000);
    ...
    private static void evenementLocal(String description) {
        ...
        try {
            ...
            // Envoi au tracker
            MessageTrackerClient.addEvent("P4", description, horlogeVectorielle);
    ...
    private static void envoyerMessage(String message, int port) {
        ...
        try {
            ...
            MessageTrackerClient.addEvent("P4", "send " + message, horlogeVectorielle);
            ...
            new Thread(() -> {
                try {
                    ...
                    synchronized (affichageLock) {
                        System.out.println("[P4] Envoi: " + message);
                        afficherHorloge();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    private static void traiterMessage(Socket socket) {
        try {
            ...
            try {
                ...
                MessageTrackerClient.addEvent("P4", "recv " + data.getMessage(), horlogeVectorielle);

...
public class Processus2 {
    ...
    public static void main(String[] args) {
        try {
            ...
            envoyerMessage("Message du P2 vers P1: Résultats d'analyse", 5001, 0);
            Thread.sleep(10000);
            ...
            envoyerMessage("Message du P2 vers P3: Optimisation terminée", 5003, 2);
            Thread.sleep(10000);
            
            evenementLocal("Validation des entrées utilisateur");
            Thread.sleep(10000);
            
            envoyerMessage("Message du P2 vers P1: Archivage terminé", 5001, 0);
            Thread.sleep(10000);
    ...
    private static void evenementLocal(String description) {
        ...
        try {
            ...
            MessageTrackerClient.addEvent("P2", description, horlogeMatricielle[PROCESSUS_ID][PROCESSUS_ID], horlogeMatricielle);
    ...
    private static void envoyerMessage(String message, int port, int dest) {
        ...
        try {
            ...
            MessageTrackerClient.addEvent("P2", "send " + message, horlogeMatricielle[PROCESSUS_ID][PROCESSUS_ID], horlogeMatricielle);
            ...
            new Thread(() -> {
                try {
                    ...
                    synchronized (affichageLock) {
                        System.out.println("[P2] Envoi: " + message + " vers le port " + port);
                        afficherHorloge();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    private static void traiterMessage(Socket socket) {
        try {
            ...
            try {
                ...
                MessageTrackerClient.addEvent("P2", eventDesc, horlogeMatricielle[PROCESSUS_ID][PROCESSUS_ID], horlogeMatricielle);

...
public class Processus3{
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Processus 3 (Scalaire) démarré sur le port 5003");
            ...
            Thread.sleep(5000);
            System.out.println("Processus 3 terminé");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private static void evenementLocal(String description) {
        ...
        try {
            ...
            compteurEvenements++;
             ...
             MessageTrackerClient.addEvent("P3", description, horloge.get()); 
            
            System.out.println("[P3] Événement local #" + compteurEvenements + 
    ...
    private static void envoyerMessage(String message, int port) {
        ...
        try {
            ...
            int horlogeCourante = horloge.get();
             MessageTrackerClient.addEvent("P3", "send " + message, horlogeCourante);
             MessageTrackerClient.addMessage("P3", "P" + (port-5000), message, horlogeCourante, 0);
            ...
            new Thread(() -> {
                try {
                    ...
                    System.out.println("[P3] Envoi à P" + (port-5000) + ": " + message + 
                                      " (H=" + horlogeCourante + ")");
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private static void traiterMessage(Socket socket) {
        try {
            ...
            MessageTrackerClient.addEvent("P3", "recv " + data.getMessage(), nouvelleHorloge);
            MessageTrackerClient.addMessage("P" + data.getProcessusId(), "P3", data.getMessage(), data.getHorloge(), nouvelleHorloge);
                
                System.out.println("[P3] Réception de P" + data.getProcessusId() + ": " + 
